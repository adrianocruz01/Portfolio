...
const Contact = () => {
    return (
        <div name='contact' className='w-full md:h-[800px] flex justify-center items-center p-4'>
            <form action='' className='flex flex-col max-w-[600px] w-full'>
                ...
                <button className='px-10 py-3 my-8 mx-auto flex items-center hover:bg-[#00df9a] hover:border-[#00df9a] text-white'>Enviar</button>
            </form>
        </div>
    );
}
